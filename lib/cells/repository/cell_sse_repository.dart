...
class CellSSERepository {
  CellSSERepository({AuthRepository? authRepository})
  ...
  Stream<SSEModel> subscribeToRefresh() async* {
    final token = await _authRepository.getToken();
    final headers = <String, String>{
      'Accept': 'text/event-stream',
      'Cache-Control': 'no-cache',
    ...
    final url = '${HttpClient.baseUrl}/cell/refresh-analytics';
    yield* SSEClient.subscribeToSSE(
