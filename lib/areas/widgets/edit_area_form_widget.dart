...
class EditAreaFormWidget extends StatefulWidget {
  final List<Area> availableAreas;
  final Area areaToEdit;

  const EditAreaFormWidget({super.key, required this.availableAreas, required this.areaToEdit});

  @override
  State<EditAreaFormWidget> createState() => _EditAreaFormWidgetState();
}

class _EditAreaFormWidgetState extends State<EditAreaFormWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Text('Modifier l\'espace', style: GardenTypography.displayLg),
        Padding(
