...
final class AlertLoaded extends AlertState {
  ...
  AlertLoaded copyWith({
    ...
    Alert? editingAlert,
    bool clearEditingAlert = false,
    Map<String, dynamic>? alertDetails,
    bool clearAlertDetails = false,
    ...
    return AlertLoaded(
      ...
      editingAlert: clearEditingAlert ? null : (editingAlert ?? this.editingAlert),
      alertDetails: clearAlertDetails ? null : (alertDetails ?? this.alertDetails),
